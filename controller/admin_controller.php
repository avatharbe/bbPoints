...
class admin_controller
{
	...
	public function display_bbaccounts()
	{
		...
		// v2.0: backfill + canonical-flip surfaces removed. bbAccounts is
		// canonical from day one; mapping is the only configuration the
		// admin needs to perform on this screen.
